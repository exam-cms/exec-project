  ...
  public render() {
    ...
    return (
      <div className="layout1">
          ...
          <div className="addbox">
            ...
            <div className="addform">
              ...
              <div className="addsub">
                ...
                <button className="surebtn" onClick={this.addGrad}>
                  提交
                </button>
              </div>
            </div>
        ...
        <div className={delflag ? "delwraper" : "delwraper isshowdel"}>
          <div className="deladdbox">
            ...
            <div className="addsub">
              <button
                className="cancelbtn"
                onClick={() => {
                  this.setState({ delflag: false, room_flag: false });
                }}
              >
                取消
              </button>
              <button
                className="surebtn"
                onClick={() => {
                  this.setState({ delflag: false, room_flag: true });
                  this.DelclassRome();
                }}
              >
                确定
